...
public class SerialComm {
    ...
    /**
     * Metodo de envio de mensaje el cual va encapsulado entre banderas.
     * @param control segmento de control
     * @param information segmento de informacion
     * @throws IOException 
     */
    static void sendMsg(int control,int information) throws IOException{
        byte[] array = { 126,(byte) control, (byte) information, 126};
        out.write(array);
    }
}
